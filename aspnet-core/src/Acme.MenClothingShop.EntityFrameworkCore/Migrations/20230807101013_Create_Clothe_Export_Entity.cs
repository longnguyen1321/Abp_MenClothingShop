...
{
    public partial class Create_Clothe_Export_Entity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenMH = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    SizeMH = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoLuongMH = table.Column<int>(type: "int", nullable: false),
                    TonKho = table.Column<int>(type: "int", nullable: false),
                    SLTonKhoToiThieu = table.Column<int>(type: "int", nullable: false),
                    LoaiMH = table.Column<int>(type: "int", nullable: false),
                    GiaMH = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ChatLieuMH = table.Column<int>(type: "int", nullable: false),
                    AnhMH = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MoTaMH = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppClothes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TongTienXuat = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TinhTrangPX = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LyDoXuat = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppExports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppExports_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThanhTienXuat = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppExportDetails", x => new { x.ExportId, x.ClotheId });
                    table.ForeignKey(
                        name: "FK_AppExportDetails_AppClothes_ClotheId",
                        column: x => x.ClotheId,
                        principalTable: "AppClothes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppExportDetails_AppExports_ExportId",
                        column: x => x.ExportId,
                        principalTable: "AppExports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppExportDetails_ClotheId",
                table: "AppExportDetails",
                column: "ClotheId");

            migrationBuilder.CreateIndex(
                name: "IX_AppExports_UserId",
                table: "AppExports",
                column: "UserId");
