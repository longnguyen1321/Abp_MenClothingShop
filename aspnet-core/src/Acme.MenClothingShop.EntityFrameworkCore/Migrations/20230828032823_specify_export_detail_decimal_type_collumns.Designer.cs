...
namespace Acme.MenClothingShop.Migrations
{
    ...
    [Migration("20230828032823_specify_export_detail_decimal_type_collumns")]
    partial class specify_export_detail_decimal_type_collumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.MenClothingShop.Clothes.Clothe", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AnhMH")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ChatLieuMH")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LoaiMH")
                        .HasColumnType("int");

                    b.Property<string>("MoTaMH")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SLTonKhoToiThieu")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.MenClothingShop.Exports.Export", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LyDoXuat")
                        .HasColumnType("int");

                    b.Property<DateTime>("NgayXuat")
                        .HasColumnType("datetime2");

                    b.Property<string>("TinhTrangPX")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("TongTienXuat")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("AppExports", (string)null);
                });

            modelBuilder.Entity("Acme.MenClothingShop.Exports.ExportDetail", b =>
                {
                    ...
                    b.ToTable("AppExportDetails", (string)null);
                });

            modelBuilder.Entity("Acme.MenClothingShop.Imports.Import", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppImports", (string)null);
                });

            modelBuilder.Entity("Acme.MenClothingShop.Imports.ImportDetail", b =>
                {
                    ...
                    b.ToTable("AppImportDetails", (string)null);
                });

            modelBuilder.Entity("Acme.MenClothingShop.Suppliers.Supllier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.MenClothingShop.Exports.ExportDetail", b =>
                {
                    ...
                    b.HasOne("Acme.MenClothingShop.Exports.Export", null)
                        .WithMany()
